...
export const Serialization_Chunk = (
    ...
    const nodes = _pr.list_to_dictionary(
        $p.chunk.nodes,
        ($) => $.id,
...
const Node = (
    ...
    return {
        ...
        'references': _pr.list_to_dictionary(
