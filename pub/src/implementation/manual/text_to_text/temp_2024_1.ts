...
import * as r_tree from "../refiners/lioncore/2024_1_tree"
...
export const $$: _pi.Refiner<d_loc.List_of_Characters, Some_Error, d_loc.List_of_Characters> = ($, abort) => _p_change_context(
