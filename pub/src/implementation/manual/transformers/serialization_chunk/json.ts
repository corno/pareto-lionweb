...
export const SerializationChunks = ($: d_in.Serialization_Chunks): d_out.Document => ['object', ['dictionary', $.__d_map(($) => SerializationChunk($))]]

export const SerializationChunk = ($: d_in.Serialization_Chunk): d_out.Document => sh.v.object({
