...
export const M3: t_signatures.M3 = ($) => ({
    ...
    'entities': _p.deprecated_cc($['entities'], ($) => $.__d_map(($) => ({
        'id': _p.deprecated_cc($['id'], ($) => ID(
            $
        )),
        'type': _p.deprecated_cc($['type'], ($) => _p.deprecated_cc($, ($): t_out.M3.entities.D.type_ => {
            switch ($[0]) {
                case 'classifier': return _p.ss($, ($) => ['classifier', ({
                    'type': _p.deprecated_cc($['type'], ($) => _p.deprecated_cc($, ($): t_out.M3.entities.D.type_.classifier.type_ => {
                        switch ($[0]) {
                            case 'concept': return _p.ss($, ($) => ['concept', ({
                            ...
                            case 'interface': return _p.ss($, ($) => ['interface', ({
                    ...
                    'features': _p.deprecated_cc($['features'], ($) => $.__d_map(($) => ({
                        'id': _p.deprecated_cc($['id'], ($) => ID(
                            $
                        )),
                        'optional': _p.deprecated_cc($['optional'], ($) => $),
                        'type': _p.deprecated_cc($['type'], ($) => _p.deprecated_cc($, ($): t_out.M3.entities.D.type_.classifier.features.D.type_ => {
                            switch ($[0]) {
                                case 'property': return _p.ss($, ($) => ['property', ({
                                    'type': _p.deprecated_cc($['type'], ($) => Raw_Reference(
                                        $
                                    )),
                                })])
                                case 'link': return _p.ss($, ($) => ['link', ({
                                    'multiple': _p.deprecated_cc($['multiple'], ($) => $),
                                    'type': _p.deprecated_cc($['type'], ($) => Raw_Reference(
                                        $
                                    )),
                                    'link type': _p.deprecated_cc($['link type'], ($) => _p.deprecated_cc($, ($): t_out.M3.entities.D.type_.classifier.features.D.type_.link.link_type => {
                                        switch ($[0]) {
                                            case 'containment': return _p.ss($, ($) => ['containment', null])
                                            case 'reference': return _p.ss($, ($) => ['reference', null])
                                            default: return _p.au($[0])
                                        }
                                    })),
                                })])
                ...
                case 'datatype': return _p.ss($, ($) => ['datatype', _p.deprecated_cc($, ($): t_out.M3.entities.D.type_.datatype => {
                    switch ($[0]) {
                        case 'enumeration': return _p.ss($, ($) => ['enumeration', $.__d_map(($) => ID(
                            $
                        ))])
                        default: return _p.au($[0])
                    }
