...
export const ID: t_signatures.ID = ($,) => ['optional', $.__decide(($,): t_out.Value.optional => ['set', ['group', ['verbose', _p.dictionary.literal(({
                                    ...
                                    case 'concept':
                                        return _p.ss($, ($,) => ({
                                            ...
                                            'value': ['group', ['verbose', _p.dictionary.literal(({
                                                ...
                                                'extends': _p.deprecated_cc($['extends'], ($,) => ['optional', $.__decide(($,): t_out.Value.optional => ['set', Raw_Reference($)], () => ['not set', null])]),
