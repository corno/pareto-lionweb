...
import * as t_signatures from "../../../../../../interface/generated/liana/schemas/serialization_chunk/signatures/refiners/list_of_characters"
...
export const Serialization_Chunks: t_signatures.Serialization_Chunks = ($, abort, $p) => v_unmarshall.Serialization_Chunks(
