...
export const Targets: t_signatures.Targets = ($,) => ['list', $.__l_map(($,) => ['group', ['verbose', _p.dictionary.literal(({
    'resolveInfo': _p.deprecated_cc($['resolveInfo'], ($,) => ['text', ({
        'delimiter': ['quote', null],
        'value': $,
    })]),
    'reference': _p.deprecated_cc($['reference'], ($,) => ['optional', $.__decide(($,): t_out.Value.optional => ['set', ['text', ({
        'delimiter': ['quote', null],
        'value': $,
    })]], () => ['not set', null])]),
}))]])]
export const Serialization_Chunk: t_signatures.Serialization_Chunk = ($,) => ['group', ['verbose', _p.dictionary.literal(({
    ...
    'nodes': _p.deprecated_cc($['nodes'], ($,) => ['list', $.__l_map(($,) => ['group', ['verbose', _p.dictionary.literal(({
        ...
        'parent': _p.deprecated_cc($['parent'], ($,) => ['optional', $.__decide(($,): t_out.Value.optional => ['set', ['text', ({
            'delimiter': ['quote', null],
            'value': $,
        })]], () => ['not set', null])]),
        'classifier': _p.deprecated_cc($['classifier'], ($,) => Meta_Pointer($)),
        ...
        'references': _p.deprecated_cc($['references'], ($,) => ['list', $.__l_map(($,) => ['group', ['verbose', _p.dictionary.literal(({
            ...
            'targets': _p.deprecated_cc($['targets'], ($,) => Targets($)),
        }))]])]),
