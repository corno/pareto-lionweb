...
import * as t_signatures from "../../../../../../interface/generated/liana/schemas/location/signatures/refiners/astn_parse_tree.js"
...
export const Range: t_signatures.Range = ($, abort) => p_change_context(
...
export const Possible_Range: t_signatures.Possible_Range = ($, abort) => p_change_context(
        ...
        ($t): t_out.Possible_Range => {
            switch ($t) {
                ...
                case 'end of document':
                    return p_change_context(
                        $['value'],
                        ($) => ['end of document', p_change_context(
                            v_unmarshalled_from_parse_tree.Verbose_Group(
                                $,
                                ($) => abort(
                                    $,
...
export const Location: t_signatures.Location = ($, abort) => p_change_context(
    v_unmarshalled_from_parse_tree.Verbose_Group(
        $,
        ($) => abort(
            $,
