...
export const ID: ID_ = ($) => v_serialize.Document(
    v_marshall.ID(
        $,
    ),
)

export const Raw_Reference: Raw_Reference_ = ($) => v_serialize.Document(
    v_marshall.Raw_Reference(
        $,
    ),
)

export const Singular_Reference: Singular_Reference_ = ($) => v_serialize.Document(
    v_marshall.Singular_Reference(
        $,
    ),
)

export const References: References_ = ($) => v_serialize.Document(
    v_marshall.References(
        $,
    ),
)

export const Optional_Reference: Optional_Reference_ = ($) => v_serialize.Document(
