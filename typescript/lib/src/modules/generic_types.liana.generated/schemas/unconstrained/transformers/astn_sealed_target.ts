...
export const ID: ID_ = ($) => ['group', ['verbose', p_.literal.dictionary(
    {
...
export const Raw_Reference: Raw_Reference_ = ($) => ['group', ['verbose', p_.literal.dictionary(
    {
...
export const References: References_ = ($) => ['list', p_.from.list($,
).map(
    ($) => Raw_Reference(
        $,
    ),
...
export const Optional_Reference: Optional_Reference_ = ($) => ['optional', p_decide_optional(
    $,
