...
export const ID: declarations.ID_ = ($) => ({
...
export const Raw_Reference: declarations.Raw_Reference_ = ($) => ({
...
export const References: declarations.References_ = ($) => p_.from.list($,
).map(
    ($) => Raw_Reference(
        $,
    ),
...
export const Optional_Reference: declarations.Optional_Reference_ = ($) => p_.from.optional($,
).map(
    ($) => Raw_Reference(
        $,
    ),
