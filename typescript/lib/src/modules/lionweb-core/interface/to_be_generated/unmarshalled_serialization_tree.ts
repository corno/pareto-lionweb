...
export type Optional_Containment = pi.Optional_Value<d_serialization_tree.Node.containments.D.D>
...
export type Optional_Property = pi.Optional_Value<d_serialization_tree.Node.properties.D>

export type Singular_Reference = d_serialization_tree.Targets.L
export type Optional_Reference = pi.Optional_Value<d_serialization_tree.Targets.L>
